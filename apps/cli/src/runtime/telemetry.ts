...
import { DEFAULT_OTLP_HTTP_ENDPOINT, LaunchKeyConfig, type LaunchKeyConfiguration } from "@launchkey/config";
...
export { DEFAULT_OTLP_HTTP_ENDPOINT } from "@launchkey/config";
...
export const telemetryLayerFromConfiguration = (config: LaunchKeyConfiguration): Layer.Layer<never> =>
